...
async function main() {
  ...
  `;
    ...
    const pick = (slugs) => slugs.map((s) => ({ id: permBySlug.get(s).id })).filter((x) => x.id);
    ...
    const hashedPassword = await bcryptjs_1.default.hash('bsn2024@admin', 10);
    ...
    await prisma.siteSettings.create({
        data: {
            ...
            siteDescription: 'Transformamos ideias em soluções tecnológicas inovadoras. Especialistas em desenvolvimento sob medida, squads ágeis e consultoria estratégica em TI.',
            ...
            metaDescription: 'Engenharia de software que transforma operações em vantagem competitiva. Desenvolvemos software sob medida, automatizamos processos e construímos squads ágeis.',
        ...
        data: [
            {
                ...
                content: 'A BSN Solution é a parceira estratégica de empresas que não aceitam soluções engessadas. Desenvolvemos software sob medida, automatizamos processos e construímos squads ágeis para acelerar sua transformação digital.',
            ...
            },
            {
                ...
                subtitle: 'Cada vidraça do nosso vitral é uma competência afiada — montadas juntas, viram soluções sob medida para o seu problema de negócio.',
                order: 2,
            },
        ],
    });
    ...
    const serviceDefinitions = [
        {
            ...
            subtitle: 'sob medida',
            description: 'Sistemas construídos para a realidade da sua operação — portais de autoatendimento, módulos de integração complexos, dashboards executivos e qualquer ferramenta que resolva um problema específico do seu negócio.',
            iconName: 'code',
            anchor: 'sob-medida',
            slug: 'sob-medida',
            numLabel: 'SVC · 01',
            ...
            heroDescription: 'Software desenhado a partir do seu processo — não o contrário. Cada linha de código existe para resolver um problema claro da sua operação, com propriedade 100% sua.',
            heroLongText: 'Em vez de adaptar um SaaS genérico a exceções infinitas, construímos a plataforma certa para como você realmente trabalha. Do diagnóstico ao go-live, sem zona cinzenta.',
            ctaTitle: 'Pronto para começar sob medida?',
            ctaText: 'Em até 45 minutos de conversa definimos viabilidade, próximos passos e um primeiro escopo enxuto. Sem lengalenga comercial.',
            ctaButtonLabel: 'Agendar diagnóstico →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que começar sob medida',
                    description: 'Quando seu processo é diferencial competitivo, um SaaS genérico vira gargalo. Construir o software certo é mais barato no médio prazo e escala junto com o negócio.',
                ...
                },
                {
                    ...
                    description: 'Discovery curto, escopo enxuto, sprints quinzenais com demo ao vivo. Você aprova cada entrega. Nenhum feature entra no roadmap sem métrica de valor.',
                    iconName: 'workflow',
                    colorClass: 'b',
                    order: 2,
                },
                {
                    ...
                    description: 'Produto rodando em produção, código e docs no seu repositório, pipeline de CI/CD, observabilidade configurada e um time pronto para evoluir o sistema ao longo do tempo.',
                    iconName: 'shield',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            heroDescription: 'Times sêniores que entram no seu fluxo como se já estivessem lá. Integração em dias, entregas em semanas — sem dor de contratação nem custo fixo sobrando.',
            heroLongText: 'Você define o desafio, a gente monta o squad certo (dev, QA, PO, designer, DevOps). Cerimônias ágeis acontecem, métricas são públicas, o escopo se ajusta ao que o negócio precisa agora.',
            ctaTitle: 'Monte seu squad ideal em dias',
            ctaText: 'Conte o desafio e o prazo — voltamos com proposta de time, rituais e métricas em até 48 horas úteis.',
            ctaButtonLabel: 'Quero montar um squad →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que começar com squads',
                    description: 'Contratação interna leva meses e trava em formação cultural. Um squad pronto entrega valor desde a primeira sprint e reduz risco de turnover no início do projeto.',
                    iconName: 'zap',
                    colorClass: 'b',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Time fixo dedicado, rituais ágeis semanais com seu PO/gestor, board compartilhado, métricas de entrega públicas. Você acompanha lead time, velocity e CSAT em tempo real.',
                    iconName: 'cpu',
                    colorClass: 'c',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Incrementos de produto a cada sprint, transferência contínua de conhecimento ao seu time interno e autonomia para aumentar, reduzir ou encerrar o squad com aviso de 30 dias.',
                    iconName: 'bot',
                    colorClass: 'd',
                    order: 3,
                },
        ...
        },
        {
            ...
            heroDescription: 'Tire trabalho repetitivo do time e devolva horas ao que move o negócio. Automação com guardrails, logs auditáveis e pessoas no loop onde importa.',
            heroLongText: 'Mapeamos o fluxo atual, identificamos o gargalo real e implementamos a automação na ordem certa — RPA, workflows, integrações, notificações. Nada de automatizar um processo errado.',
            ctaTitle: 'Quais processos devolveriam mais tempo?',
            ctaText: 'Fazemos um diagnóstico rápido e apontamos até 3 automações com maior ROI na sua operação antes de qualquer contrato.',
            ctaButtonLabel: 'Mapear meus processos →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que automatizar agora',
                    description: 'Todo processo repetitivo custa horas que deveriam virar produto ou atendimento. Automação bem feita paga o investimento no primeiro trimestre e liberta o time para trabalho de maior valor.',
                    iconName: 'scissors',
                    colorClass: 'a',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Diagnóstico de fluxo em 1 semana, priorização por ROI, implementação incremental e revisão conjunta antes do go-live. Monitoramento ativo e pessoas no loop em decisões críticas.',
                ...
                {
                    title: 'O que entregamos',
                    description: 'Automação rodando, logs auditáveis, alertas configurados e documentação acessível ao seu time. Você opera e audita; a gente mantém e evolui quando os sistemas mudam.',
                    iconName: 'gauge',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            heroDescription: 'Clareza sobre stack, time, débito técnico e roadmap. Diagnóstico honesto e recomendações priorizadas — sem jargão nem agenda de venda de mais horas.',
            heroLongText: 'Mergulhamos na sua arquitetura, entrevistamos o time, analisamos métricas reais e entregamos um plano concreto com quick wins e apostas estratégicas. Você decide o que executar, com quem.',
            ctaTitle: 'Seu tech stack está ajudando ou atrapalhando?',
            ctaText: 'Em 2 semanas entregamos um relatório executivo com diagnóstico, priorização e ROI esperado para cada decisão.',
            ctaButtonLabel: 'Solicitar diagnóstico →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que consultar',
                    description: 'Decisões técnicas tomadas sem diagnóstico independente acumulam dívida silenciosa. Uma revisão externa revela bottlenecks que o time interno já normalizou e economiza seis dígitos em retrabalho.',
                    iconName: 'brain',
                    colorClass: 'c',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Duas semanas imersos na sua realidade: code review, entrevistas com time, análise de métricas, benchmarks. Nenhuma recomendação sem evidência concreta no relatório final.',
                    iconName: 'file-search',
                    colorClass: 'a',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Relatório executivo + plano de ação priorizado por ROI + sessão de debrief com sua liderança. Sem amarra de continuidade — você pode executar com a gente, com seu time, ou com um terceiro.',
                    iconName: 'line-chart',
                    colorClass: 'd',
                    order: 3,
                },
        ...
        },
        {
            ...
            description: 'Servidores dimensionados para sua carga real, com backups, segurança, observabilidade e atualizações inclusas. Você usa a ferramenta; a gente cuida do resto.',
            iconName: 'server',
            anchor: 'infra',
            slug: 'infra',
            numLabel: 'SVC · 05',
            ...
            heroDescription: 'Infraestrutura dimensionada pro seu tráfego real, com SLA claro e observabilidade fim-a-fim. Cloud-agnostic, backup testado, sem amarra de fornecedor.',
            heroLongText: 'Você opera o produto; a gente opera a infra. Dimensionamento honesto, migrações sem drama, backup testado semanalmente e alerta que só toca quando precisa.',
            ctaTitle: 'Sua infra atual está pronta para escalar?',
            ctaText: 'Rodamos um health check gratuito de 48 horas com recomendações concretas antes de qualquer proposta.',
            ctaButtonLabel: 'Pedir health check →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que nos preocupar com infra',
                    description: 'Infra mal dimensionada é o custo invisível do crescimento: conta de cloud inflada, incidentes frequentes e deploy lento. Uma revisão enxuta recupera margem e confiabilidade.',
                    iconName: 'shield',
                    colorClass: 'e',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Auditoria de custo e arquitetura, IaC versionado, pipelines de deploy blue-green, observabilidade com SLOs acordados. Migração incremental com rollback pronto.',
                    iconName: 'workflow',
                    colorClass: 'b',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Infra documentada, SLA mensal com métricas reais, backup testado e plantão 24/7 opcional. Sem lock-in — todo o IaC fica no seu repositório.',
                    iconName: 'database',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            heroDescription: 'Relação contínua com o time que construiu (ou entendeu) seu sistema. Sem reabrir contrato a cada melhoria — roadmap compartilhado, entregas previsíveis.',
            heroLongText: 'Além de apagar incêndio: cuidamos de dívida técnica, evolução funcional, upgrade de stack e onboarding de novos membros do seu time. SLA ajustado à criticidade real do produto.',
            ctaTitle: 'Quer um time de plantão que já conhece seu código?',
            ctaText: 'Planos a partir de 20h/mês com roadmap compartilhado e priorização conjunta. Sem surpresas em fatura.',
            ctaButtonLabel: 'Conhecer planos de suporte →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que ter suporte contínuo',
                    description: 'Todo sistema em produção acumula dívida, requer ajustes regulatórios e ganha demanda nova. Ter o time certo à mão reduz MTTR e evita o ciclo "parar tudo para apagar incêndio".',
                    iconName: 'zap',
                    colorClass: 'a',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Plantão técnico com níveis de prioridade acordados, roadmap compartilhado em board público, planning mensal conjunto e relatório executivo de atividades ao fim de cada ciclo.',
                    iconName: 'clock',
                    colorClass: 'b',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'SLAs honrados, dívida técnica tratada em esteira, features novas entregues a cada sprint e conhecimento transferido ao seu time continuamente. Sem reféns.',
                    iconName: 'shield',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            heroDescription: 'Terceirize frentes específicas com previsibilidade de custo e qualidade superior à contratação interna. Você mantém o foco estratégico; a gente toca execução.',
            heroLongText: 'Dev, QA, SRE, Data, Produto, Design — alocamos os perfis que seu negócio demanda, com contratos flexíveis e saída limpa sempre que você quiser internalizar.',
            ctaTitle: 'Onde terceirizar agora faz mais sentido?',
            ctaText: 'Conte a demanda — avaliamos e respondemos com perfis, custos e SLA esperado em até 2 dias úteis.',
            ctaButtonLabel: 'Quero terceirizar →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que terceirizar estratégico',
                    description: 'Nem tudo precisa ser feito in-house. Terceirizar frentes bem delimitadas libera liderança interna para o core do negócio e traz maturidade que demoraria anos para construir.',
                    iconName: 'trending-up',
                    colorClass: 'd',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Perfis selecionados, contrato de SLA claro, integração ao seu processo (ferramentas, cerimônias, código) e governança de entrega auditável mês a mês.',
                    iconName: 'cpu',
                    colorClass: 'a',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Capacidade imediata, conhecimento transferível, documentação de tudo que é construído e opção real de internalizar o time com aviso prévio de 60 dias.',
                    iconName: 'bot',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            subtitle: 'aplicada',
            description: 'Agentes, automações e modelos sob medida que resolvem problemas reais da sua operação — com dados, métricas e guardrails. Menos hype, mais integração profunda com seus sistemas.',
            iconName: 'brain',
            anchor: 'ia',
            slug: 'ia',
            numLabel: 'SVC · 08',
            ...
            heroDescription: 'IA que vira resultado no balanço — não promessa em keynote. Construímos agentes, automações e modelos com dados, métricas e plano claro.',
            heroLongText: 'Discovery honesto para separar o que dá ROI do que é demo de conferência. Depois, engenharia pesada: LLMs, RAG, agentes, guardrails, observabilidade.',
            ctaTitle: 'Onde a IA faria diferença real no seu negócio?',
            ctaText: 'Fazemos um discovery de 2 semanas e voltamos com casos priorizados por impacto, viabilidade técnica e prontidão dos seus dados.',
            ctaButtonLabel: 'Explorar casos com IA →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que IA agora',
                    description: 'LLMs derrubaram o custo de tarefas antes inviáveis: triagem, classificação, assistência. Usada com critério, vira vantagem competitiva — usada com hype, vira teatro caro.',
                    iconName: 'sparkles',
                    colorClass: 'a',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Discovery IA → prova de conceito em 2-4 semanas → construção com guardrails → operação com MLOps. Sempre ancorados em métrica de negócio, nunca em métrica de modelo.',
                    iconName: 'workflow',
                    colorClass: 'b',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Agente ou modelo em produção, integrado aos seus sistemas, com observabilidade, guardrails éticos, logs auditáveis e rituais mensais de retraining baseados em uso real.',
                    iconName: 'bot',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            description: 'Antes do modelo, a fundação: diagnóstico de maturidade, integração de fontes, pipelines confiáveis e governança. Sem dados bons, IA vira teatro caro.',
            iconName: 'database',
            anchor: 'dados-ia',
            slug: 'dados-ia',
            numLabel: 'SVC · 09',
            ...
            heroDescription: 'Antes de qualquer modelo, a base. Integramos fontes, organizamos qualidade e colocamos governança — a fundação sem a qual IA nunca sai do PowerPoint.',
            heroLongText: 'Lakehouse ou DW com arquitetura versionada, pipelines ETL/ELT auditáveis, catálogo e linhagem documentados, conformidade com LGPD. Dados como ativo, não como aglomerado.',
            ctaTitle: 'Sua base está pronta para IA?',
            ctaText: 'Em 2 semanas entregamos um diagnóstico de maturidade de dados + plano incremental de engenharia para destravar casos com mais impacto.',
            ctaButtonLabel: 'Diagnosticar base →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que começar por dados',
                    description: 'IA é tão boa quanto os dados que a alimentam. Pular a fundação acelera o fracasso — um diagnóstico honesto evita investir em modelo antes de ter o insumo básico pronto.',
                    iconName: 'database',
                    colorClass: 'e',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Mapa de fontes, qualidade e volume → arquitetura de lakehouse ou DW → pipelines versionados com testes → catálogo e políticas de acesso. Passo a passo, com quick wins pelo caminho.',
                    iconName: 'workflow',
                    colorClass: 'b',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Arquitetura de dados documentada, pipelines rodando em produção, governança clara (quem acessa o quê, por quê, com que auditoria) e prontidão real para os próximos casos de IA.',
                    iconName: 'shield',
                    colorClass: 'c',
                    order: 3,
                },
        ...
        },
        {
            ...
            subtitle: 'concept',
            description: 'Transformamos ideia em hipótese validada. Problema redondo, persona clara, proposta de valor afiada e um MVP enxuto — tudo em semanas, antes de escrever código caro.',
            iconName: 'rocket',
            ...
            heroDescription: 'Da ideia à hipótese validada. Em vez de construir e torcer, descobrimos o que merece virar produto antes de gastar a primeira linha de código.',
            heroLongText: 'Combinação de pesquisa, design e arquitetura para sair com uma hipótese afiada: problema redondo, persona clara, proposta de valor, MVP minimamente útil e um critério honesto de go / no-go.',
            ctaTitle: 'Sua ideia está pronta para virar produto?',
            ctaText: 'Em 3 semanas validamos proposta, usuário e viabilidade técnica. Você sai com um plano — ou com um "não invista nisso".',
            ctaButtonLabel: 'Começar discovery →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que começar por discovery',
                    description: 'A maioria dos produtos morre não por má execução, mas por ter resolvido o problema errado. Um discovery curto e honesto economiza 6 meses de engenharia que iria pra gaveta.',
                    iconName: 'file-search',
                    colorClass: 'a',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Entrevistas com usuários reais, mapa de jornadas, protótipo navegável, testes de desejabilidade e viabilidade técnica. Reports públicos a cada semana — nada escondido pra justificar honorário.',
                    iconName: 'brain',
                    colorClass: 'c',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Hipótese escrita, protótipo testado, backlog priorizado pra MVP e uma recomendação clara: prossiga, ajuste ou descarte. Tudo no seu repositório, sem lock-in.',
                    iconName: 'sparkles',
                    colorClass: 'b',
                    order: 3,
                },
        ...
        },
        {
            ...
            heroDescription: 'Produto bom em operação ruim não escala. Redesenhamos a jornada completa do seu cliente — com atrito reduzido, processos claros e papéis afinados.',
            heroLongText: 'Blueprint completo de frontstage e backstage, mapeamento de dor e de encantamento, reescrita de processos críticos e métricas de experiência com plano de ação.',
            ctaTitle: 'Onde o seu serviço perde clientes hoje?',
            ctaText: 'Fazemos uma imersão de 2 semanas, mapeamos a jornada real e voltamos com as 3 intervenções de maior impacto em CX e operação.',
            ctaButtonLabel: 'Mapear jornada →',
            ctaButtonUrl: '/contato',
            blocks: [
                {
                    title: 'Por que redesenhar o serviço',
                    description: 'Produto digital é só parte da experiência. Onboarding lento, suporte confuso ou cobrança opaca destroem percepção de valor mesmo quando o software é excelente.',
                    iconName: 'scissors',
                    colorClass: 'c',
                    order: 1,
                },
                {
                    title: 'Como trabalhamos',
                    description: 'Entrevistas com clientes reais, observação de operação, workshops com times internos (atendimento, vendas, sucesso). Blueprint do serviço versionado e priorização conjunta.',
                    iconName: 'workflow',
                    colorClass: 'a',
                    order: 2,
                },
                {
                    title: 'O que entregamos',
                    description: 'Blueprint detalhado, redesign dos processos mais críticos, playbooks para times operacionais e métricas de experiência com baseline + metas mensuráveis.',
                    iconName: 'line-chart',
                    colorClass: 'd',
                    order: 3,
                },
        ...
        data: [
            {
                ...
                tag: 'SAAS · B2B',
                description: 'Área logada completa onde seus clientes consultam status, abrem chamados e acessam documentos sem depender do suporte.',
                bullets: [
            ...
            },
            {
                ...
                tag: 'IA · MESSAGING',
                description: 'Centralize conversas, distribua atendimentos e automatize respostas com IA treinada na sua base de conhecimento.',
                bullets: [
            ...
            },
            {
                ...
                tag: 'VAREJO · PDV',
                description: 'Frente de caixa rápida, offline-ready, com emissão fiscal, pagamento integrado e relatórios em tempo real.',
                bullets: [
            ...
            },
            {
                ...
                tag: 'MOBILIDADE',
                description: 'App offline-first pra times externos: pipeline de vendas, checklists, fotos, assinaturas e sync quando voltar ao sinal.',
                bullets: [
            ...
            },
            {
                ...
                tag: 'INTEGRAÇÃO · ETL',
                description: 'Sincronização resiliente entre ERPs, e-commerces, marketplaces e sistemas legados — com fila, retry e observabilidade.',
                bullets: [
            ...
            },
            {
                ...
                tag: 'ERP · WORKFLOW',
                description: 'Sistema interno sob medida pra centralizar processos, aprovações e indicadores da sua operação — sem planilhas compartilhadas.',
                bullets: [
        ...
        data: [
            {
                ...
                excerpt: 'Um estudo com 14 administradoras mostrou que o ROI de soluções customizadas supera o de SaaS em até 3× ao longo de 24 meses — e explicamos por quê.',
                content: 'Operações complexas acumulam exceções que SaaS genérico não cobre. Este long read apresenta a metodologia que usamos para avaliar quando sob medida vence — e os casos em que SaaS ainda faz sentido.',
        ...
        data: [
            {
                ...
                description: 'Queremos que líderes vejam tecnologia como alavanca — não como gargalo. Traduzimos visão de negócio em sistemas que escalam.',
                colorClass: 'c1',
                order: 1,
            },
            {
            ...
            },
            {
                ...
                description: 'Nossos relatórios mostram o que funcionou e o que não — porque essa é a única forma de evoluir de verdade.',
                colorClass: 'c3',
                order: 3,
            },
            {
        ...
        data: [
            {
                number: '01',
                title: 'Diagnóstico',
                description: 'Mergulhamos na sua operação para entender contexto, dor real e restrições. Sem tecniquês.',
                duration: '1 semana',
                order: 1,
            },
            {
                number: '02',
                title: 'Proposta',
                description: 'Escopo claro com entregas, prazos e preço fixo. Você decide o que entra no MVP.',
                duration: '3-5 dias',
                order: 2,
            },
            {
                ...
                description: 'Squad montado em 5 dias. Demos semanais, sem surpresas — você acompanha cada sprint.',
            ...
            },
            {
                ...
                description: 'Deploy monitorado 24/7 + roadmap contínuo. A parceria não acaba no lançamento.',
                duration: 'contínuo',
                order: 4,
            },
        ],
    ...
    await prisma.aIBlock.createMany({
        data: [
            // ─── HERO BENEFITS (4 cards) ───
            {
                ...
                description: 'Produtos inteligentes que desbloqueiam ofertas personalizadas, cobrança dinâmica e canais antes inviáveis.',
                bullets: [],
                colorClass: 'a',
                iconName: 'trending-up',
                order: 1,
            },
            {
                ...
                description: 'Automação real de fluxos repetitivos — back-office, atendimento, triagem — sem substituir o julgamento humano nas decisões críticas.',
                bullets: [],
                colorClass: 'b',
                iconName: 'scissors',
                order: 2,
            },
            {
                ...
                description: 'Agentes de IA liberam analistas, devs e gestores do trabalho mecânico e devolvem horas para o que move o negócio.',
                bullets: [],
                colorClass: 'c',
                iconName: 'zap',
                order: 3,
            },
            {
                ...
                description: 'Modelos que leem sinais fracos e entregam recomendações onde a decisão acontece — não num relatório que ninguém abre.',
                bullets: [],
                colorClass: 'd',
                iconName: 'brain',
                order: 4,
            ...
            // ─── STAGES (3 etapas) ───
            {
                ...
                title: 'Discovery IA',
                description: 'Diagnóstico técnico e de negócio para separar ideias vendidas em keynote do que realmente move o ponteiro na sua operação.',
                bullets: [
            ...
            },
            {
                ...
                description: 'Engenharia de produto pesada: LLMs, RAG, fine-tuning, agentes autônomos e modelos sob medida — integrados aos seus sistemas existentes.',
                bullets: [
            ...
            },
            {
                ...
                description: 'Times sêniores dedicados que evoluem o produto mês a mês: MLOps, avaliação contínua, fine-tuning dirigido por feedback real de usuários.',
                bullets: [
            ...
            // ─── EDU_HIGHLIGHT (2 destaques) ───
            {
                ...
                description: 'Antes de qualquer modelo, a gente organiza a casa: integração de fontes, qualidade, rotulagem e governança. Sem isso, IA vira teatro caro.',
                bullets: [
            ...
            },
            {
                ...
                description: 'Modelos em produção precisam explicar decisões, respeitar LGPD e ter limites claros. A gente constrói isso como parte do produto, não como remendo.',
                bullets: [
