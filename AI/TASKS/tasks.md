...
- [x] Rota de autenticação (/api/auth)

### 🔄 Em Andamento
- [ ] Rotas do backend (home, services, solutions, etc.)
- [ ] Frontend (React + Vite + Shadcn/ui + tema escuro)
- [ ] Dockerfiles e containerização final
